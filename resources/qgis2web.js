...
map.getView().fit([-11024994.417748, 2198691.898718, -11002917.542890, 2209907.200838], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Incidencias del Agua Chimalhuacan</h2>';
        return titleElement;
    })(),
