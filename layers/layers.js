...
var format_Chimalhuacan_1 = new ol.format.GeoJSON();
var features_Chimalhuacan_1 = format_Chimalhuacan_1.readFeatures(json_Chimalhuacan_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Chimalhuacan_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Chimalhuacan_1.addFeatures(features_Chimalhuacan_1);
var lyr_Chimalhuacan_1 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Chimalhuacan_1, 
                style: style_Chimalhuacan_1,
                popuplayertitle: 'Chimalhuacan',
                interactive: false,
                title: '<img src="styles/legend/Chimalhuacan_1.png" /> Chimalhuacan'
            });
...
var lyr_Incidencias_3 = new ol.layer.Vector({
    ...
    <img src="styles/legend/Incidencias_3_0.png" /> Falta de agua<br />\
    <img src="styles/legend/Incidencias_3_1.png" /> Drenaje tapado / Coladrera tapada / Tuberia tapada<br />'
        });

lyr_Positron_0.setVisible(true);lyr_Chimalhuacan_1.setVisible(true);lyr_colonias_2.setVisible(true);lyr_Incidencias_3.setVisible(true);
var layersList = [lyr_Positron_0,lyr_Chimalhuacan_1,lyr_colonias_2,lyr_Incidencias_3];
lyr_Chimalhuacan_1.set('fieldAliases', {'qc_id': 'qc_id', 'id': 'id', 'cveigecem': 'cveigecem', 'cveinegi': 'cveinegi', 'nom_mun': 'nom_mun', 'iddeleg': 'iddeleg', 'area_km2_o': 'area_km2_o', 'area_km2': 'area_km2', 'PobTotal': 'PobTotal', });
...
lyr_Chimalhuacan_1.set('fieldImages', {'qc_id': 'TextEdit', 'id': 'TextEdit', 'cveigecem': 'TextEdit', 'cveinegi': 'TextEdit', 'nom_mun': 'TextEdit', 'iddeleg': 'TextEdit', 'area_km2_o': 'TextEdit', 'area_km2': 'TextEdit', 'PobTotal': 'TextEdit', });
...
lyr_Chimalhuacan_1.set('fieldLabels', {'qc_id': 'hidden field', 'id': 'hidden field', 'cveigecem': 'hidden field', 'cveinegi': 'hidden field', 'nom_mun': 'hidden field', 'iddeleg': 'hidden field', 'area_km2_o': 'hidden field', 'area_km2': 'no label', 'PobTotal': 'no label', });
